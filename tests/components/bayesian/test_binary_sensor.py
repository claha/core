...
def test_load_values_when_added_to_hass(hass):
    ...
    hass.states.set("sensor.test_monitored", "off")
    hass.block_till_done()

    assert setup_component(hass, "binary_sensor", config)
    hass.block_till_done()
...
def test_unknown_state_does_not_influence_probability(hass):
    ...
    hass.states.set("sensor.test_monitored", STATE_UNKNOWN)
    hass.block_till_done()
...
def test_sensor_numeric_state(hass):
    ...
    hass.states.set("sensor.test_monitored", 4)
    hass.block_till_done()
    ...
    hass.states.set("sensor.test_monitored", 6)
    hass.block_till_done()
    hass.states.set("sensor.test_monitored", 4)
    hass.block_till_done()
    hass.states.set("sensor.test_monitored", 6)
    hass.states.set("sensor.test_monitored1", 6)
    hass.block_till_done()
    ...
    hass.states.set("sensor.test_monitored", 6)
    hass.states.set("sensor.test_monitored1", 0)
    hass.block_till_done()
    hass.states.set("sensor.test_monitored", 4)
    hass.block_till_done()
    ...
    hass.states.set("sensor.test_monitored", 15)
    hass.block_till_done()
...
def test_sensor_state(hass):
    ...
    hass.states.set("sensor.test_monitored", "on")
...
def test_sensor_value_template(hass):
...
def test_multiple_observations(hass):
    ...
    hass.states.set("sensor.test_monitored", "blue")
    hass.block_till_done()
    hass.states.set("sensor.test_monitored", "off")
    hass.block_till_done()
    hass.states.set("sensor.test_monitored", "blue")
    ...
    hass.states.set("sensor.test_monitored", "blue")
    hass.block_till_done()
    hass.states.set("sensor.test_monitored", "red")
    hass.block_till_done()
...
def test_probability_updates(hass):
...
def test_observed_entities(hass):
    ...
    hass.states.set("sensor.test_monitored", "on")
    hass.block_till_done()
    hass.states.set("sensor.test_monitored1", "off")
    hass.block_till_done()
    ...
    hass.states.set("sensor.test_monitored1", "on")
    hass.block_till_done()
...
def test_state_attributes_are_serializable(hass):
    """Test sensor on observed entities."""
    config = {
        "binary_sensor": {
            "name": "Test_Binary",
